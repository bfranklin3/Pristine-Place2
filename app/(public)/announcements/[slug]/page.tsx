// app/(public)/announcements/[slug]/page.tsx
...
export async function generateMetadata({ params }: AnnouncementPageProps): Promise<Metadata> {
  ...
  return {
    title: `${announcement.title} | ${siteConfig.name}`,
          ...
          <div className="stack" style={{ gap: "var(--space-l)" }}>
            ...
            <div className="stack" style={{ gap: "var(--space-s)", alignItems: "center" }}>
              ...
              <p className="text-fluid-sm text-pp-slate-500">
                Questions? <Link href="/contact" className="text-pp-navy hover:underline">Contact the HOA office</Link>
              </p>
            </div>
          </div>
        </div>
